...
date: '2019-09-26'
category: 'notion'
description: 'My Basecamp approach to tracking life with Notion: schedules, tasks, and relational databases.'
---

I use Notion as a one-stop shop for a lot of my life's work. Between planning camping trips and remembering to stop by the post office, I've learned I have to write things down or I simply will not remember to do them. Notion has helped me track these items in a very straightforward way. I start my days on a single page from which I can view the week or month ahead in addition to the tasks I intend to accomplish in that time. I call this my **Basecamp**.
...
This setup has worked for me for years. I tweak it every few months, but the core idea — one basecamp page, two sections — hasn't changed.
