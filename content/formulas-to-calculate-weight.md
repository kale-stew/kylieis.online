...
date: '2020-04-16'
category: 'notion'
description: 'How I adapted a Notion plant tracker template to track backpacking gear weight by trip type.'
---

I needed a better way to track my gear weight by trip type. A plant tracker template turned out to be the perfect starting point.
...
This is one of those setups I tweak every season.
