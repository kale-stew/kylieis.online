  ...
  return html`
    ...
    <html lang="en">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=Fraunces:opsz,wght@9..144,400;9..144,500&family=Righteous&family=Anton&family=Bebas+Neue&family=Bowlby+One+SC&family=Luckiest+Guy&display=swap" rel="stylesheet" />
