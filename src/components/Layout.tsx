  ...
  return html`
    ...
    <html lang="en">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=Fraunces:opsz,wght@9..144,400;9..144,500&family=Monoton&family=Rubik+Glitch&family=Nabla&family=Silkscreen&family=Bitcount+Prop+Single&family=Megrim&family=Atomic+Age&family=Major+Mono+Display&family=Nanum+Gothic+Coding&family=Jersey+10&display=swap" rel="stylesheet" />
