...
export const PHOTOS: Photo[] = [
  ...
  // Featured from climb-log
  { src: 'https://climb-log.kylieski.workers.dev/img/400ddabc?w=800', alt: 'Sunset at Pillar Point', location: 'Half Moon Bay, CA', date: '2024-12-05' },
  { src: 'https://climb-log.kylieski.workers.dev/img/fc9f3d6b?w=800', alt: 'Golden Gate from Fort Point', location: 'San Francisco, CA', date: '2024-10-13' },
  { src: 'https://climb-log.kylieski.workers.dev/img/fe3c74ef?w=800', alt: 'Grand Teton Lupine', location: 'Grand Teton National Park, WY', date: '2024-08-05' },
  { src: 'https://climb-log.kylieski.workers.dev/img/b842df62?w=800', alt: 'Delta Lake', location: 'Grand Teton National Park, WY', date: '2024-08-01' },
  { src: 'https://climb-log.kylieski.workers.dev/img/137ec2ba?w=800', alt: 'Ute Petroglyphs', location: 'Utah', date: '2024-02-09' },
  { src: 'https://climb-log.kylieski.workers.dev/img/65269de3?w=800', alt: 'Winter in Southern Utah', location: 'Red Cliffs Conservancy, UT', date: '2023-12-21' },
  { src: 'https://climb-log.kylieski.workers.dev/img/a9872b62?w=800', alt: 'Ally on the Knife\'s Edge', location: 'Elk Range, CO', date: '2023-07-29' },
  { src: 'https://climb-log.kylieski.workers.dev/img/079fd42c?w=800', alt: 'Ally seen from El Diente\'s summit', location: 'San Juan Range, CO', date: '2023-07-22' },
  { src: 'https://climb-log.kylieski.workers.dev/img/58554a63?w=800', alt: 'A crevasse', location: 'Mount Baker, WA', date: '2023-06-18' },
  { src: 'https://climb-log.kylieski.workers.dev/img/13a1c7f3?w=800', alt: 'The Subway Cave', location: 'Coconino National Forest, AZ', date: '2023-06-07' },
  { src: 'https://climb-log.kylieski.workers.dev/img/8ed092ea?w=800', alt: 'Cassidy Arch', location: 'Capitol Reef National Park, UT', date: '2023-06-04' },
  { src: 'https://climb-log.kylieski.workers.dev/img/ca352bee?w=800', alt: 'Walking behind South Falls', location: 'Silver Falls State Park, OR', date: '2023-05-21' },
  { src: 'https://climb-log.kylieski.workers.dev/img/bfbfdd92?w=800', alt: 'Blooming Cactus', location: 'Red Cliffs Conservancy, UT', date: '2023-05-13' },
  { src: 'https://climb-log.kylieski.workers.dev/img/a4e71785?w=800', alt: 'Self portrait', location: 'Fisher Towers, UT', date: '2022-11-06' },
  { src: 'https://climb-log.kylieski.workers.dev/img/721ff4ba?w=800', alt: 'Driving in the San Juans', location: 'San Juan Range, CO', date: '2022-10-10' },
  { src: 'https://climb-log.kylieski.workers.dev/img/1be3ff35?w=800', alt: 'Sunset on Lake Clark', location: 'Lake Clark National Park, AK', date: '2022-09-20' },
  { src: 'https://climb-log.kylieski.workers.dev/img/e5cbd67c?w=800', alt: 'Fall Colors on Lake Kontrashibuna', location: 'Lake Clark National Park, AK', date: '2022-09-20' },
  { src: 'https://climb-log.kylieski.workers.dev/img/123baf7f?w=800', alt: 'Aerial Views of Lake Clark', location: 'Lake Clark National Park, AK', date: '2022-09-21' },
  { src: 'https://climb-log.kylieski.workers.dev/img/396e2c74?w=800', alt: 'Precipice and Dunsinane Peaks', location: 'San Juan Range, CO', date: '2022-09-03' },
  { src: 'https://climb-log.kylieski.workers.dev/img/9b7aff98?w=800', alt: 'View from Middle Mountain', location: 'San Juan Range, CO', date: '2022-06-05' },
  { src: 'https://climb-log.kylieski.workers.dev/img/18f62921?w=800', alt: 'Chicago Basin Goats', location: 'San Juan Range, CO', date: '2022-08-06' },
  { src: 'https://climb-log.kylieski.workers.dev/img/efcf7090?w=800', alt: 'Flying back to Anchorage', location: 'Alaska', date: '2022-09-21' },
  { src: 'https://climb-log.kylieski.workers.dev/img/fe75841a?w=800', alt: 'Lower South Falls', location: 'Silver Falls State Park, OR', date: '2023-05-21' },
  { src: 'https://climb-log.kylieski.workers.dev/img/dac836a2?w=800', alt: 'Beginning the Roman Wall', location: 'Mount Baker, WA', date: '2023-06-18' },
  { src: 'https://climb-log.kylieski.workers.dev/img/7ecc4b31?w=800', alt: 'Ants on Easton Glacier', location: 'Mount Baker, WA', date: '2023-06-18' },
  { src: 'https://climb-log.kylieski.workers.dev/img/cbbd371c?w=800', alt: 'Looking at Snowmass', location: 'Elk Range, CO', date: '2023-07-29' },
  { src: 'https://climb-log.kylieski.workers.dev/img/500860b0?w=800', alt: 'Elephant Arch', location: 'Utah', date: '2023-12-21' },
  { src: 'https://climb-log.kylieski.workers.dev/img/d48528a3?w=800', alt: 'Alpenglow on Gladstone', location: 'San Juan Range, CO', date: '2022-07-01' },
  { src: 'https://climb-log.kylieski.workers.dev/img/2f0846eb?w=800', alt: 'Luis on Missouri Ridge', location: 'Sawatch Range, CO', date: '2021-11-18' },
  { src: 'https://climb-log.kylieski.workers.dev/img/570ea8b6?w=800', alt: 'Capitol Peak in the Fall', location: 'Elk Range, CO', date: '2021-10-03' },
  { src: 'https://climb-log.kylieski.workers.dev/img/5fd733fd?w=800', alt: '"Point of No Return"', location: 'Elk Range, CO', date: '2023-12-22' },
  { src: 'https://climb-log.kylieski.workers.dev/img/cb06b04c?w=800', alt: 'Delicate Arch with Fresh Snow', location: 'Arches National Park, UT', date: '2024-02-09' },
]
